...
(function () {
    ...
    jsblock.prototype = {
        ...
        createRunButton: function () {
            ...
            this.runButton.innerText = '运行';
            this.runButton.href = 'javascript:void 0;';
        ...
        createResetButton: function () {
            ...
            this.resetButton.innerText = '重置';
            this.resetButton.href = 'javascript:void 0;';
            this.addResetButtonEvent();
            return this.resetButton;
        },
        createBacklink: function () {
            this.backlink = document.createElement('a');
            this.backlink.classList.add('jsblock-console-back');
            this.backlink.innerText = '返回主页';
            this.backlink.href = this.options.backhome;
